...
func Active(v bool) predicate.Guild {
	return predicate.Guild(sql.FieldEQ(FieldActive, v))
}
...
func ActiveEQ(v bool) predicate.Guild {
	return predicate.Guild(sql.FieldEQ(FieldActive, v))
}

// ActiveNEQ applies the NEQ predicate on the "active" field.
func ActiveNEQ(v bool) predicate.Guild {
	return predicate.Guild(sql.FieldNEQ(FieldActive, v))
}
...
func HasChannelsWith(preds ...predicate.Channel) predicate.Guild {
	return predicate.Guild(func(s *sql.Selector) {
