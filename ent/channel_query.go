...
func (cq *ChannelQuery) QueryOwner() *GuildQuery {
	query := (&GuildClient{config: cq.config}).Query()
...
func (cq *ChannelQuery) WithOwner(opts ...func(*GuildQuery)) *ChannelQuery {
	query := (&GuildClient{config: cq.config}).Query()
...
func (cq *ChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Channel, error) {
	...
	if query := cq.withOwner; query != nil {
		if err := cq.loadOwner(ctx, query, nodes, nil,
			func(n *Channel, e *Guild) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
...
func (cq *ChannelQuery) loadOwner(ctx context.Context, query *GuildQuery, nodes []*Channel, init func(*Channel), assign func(*Channel, *Guild)) error {
...
func (cq *ChannelQuery) loadMessages(ctx context.Context, query *MessageQuery, nodes []*Channel, init func(*Channel), assign func(*Channel, *Message)) error {
...
func (cq *ChannelQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := cq.ctx.Fields; len(fields) > 0 {
		...
		if cq.withOwner != nil {
			_spec.Node.AddColumnOnce(channel.FieldGuildID)
		}
	}
